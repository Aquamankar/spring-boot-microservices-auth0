...
//            Collection<GrantedAuthority> customRoles = jwt.getClaimAsStringList("https://dailycodebuffer.com/roles")
//                    .stream()
//                    .map(role -> new SimpleGrantedAuthority("ROLE_" + role))
//                    .collect(Collectors.toList());
//            authorities.addAll(customRoles);
//
//            // Extract audience-based authorities
//            Collection<GrantedAuthority> audienceRoles = jwt.getClaimAsStringList("https://dailycodebuffer.com/audiences")
//                    .stream()
//                    .map(aud -> {
//                        if (aud.contains("customer")) {
//                            return new SimpleGrantedAuthority("ROLE_CUSTOMER");
//                        } else if (aud.contains("admin")) {
...
//                    .collect(Collectors.toList());
//            authorities.addAll(audienceRoles);
//
//            return authorities;
//        });
//
